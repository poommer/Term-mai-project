...
<head>
    ...
    <title>บัตรเติมเงิน Line Prepaid | trem-mai.com</title>
</head>
        ...
        <main>
            <div class="container">
                ...
                <div class="main-container">
                    <!-- main1 -->
                    <div class="pro-img">
                        <img src="../../img/game/1_LINEprepaid.png" alt="">
                    </div>
                    <!-- end main1 -->
                    <!-- main2 -->
                    <div class="pro-inf">
                        <div class="pro-inf-name">
                            <h1>บัตรเติมเงิน Line Prepaid</h1>
                        </div>

                        <div class="pro-inf-details">
                            <div class="sale-price">
                                <form action="">
                                    <input type="button" value="100 บาท" id="btn1" data-name="บัตรเติมเงิน Line Prepaid มูลค่า 100 บาท" data-price="98.00" onclick="price(document.getElementById('btn1')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="300 บาท" id="btn2" data-name="บัตรเติมเงิน Line Prepaid มูลค่า 300 บาท" data-price="294.00" onclick="price(document.getElementById('btn2')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="500 บาท" id="btn3" data-name="บัตรเติมเงิน Line Prepaid มูลค่า 500 บาท" data-price="490.00" onclick="price(document.getElementById('btn3')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    </form>
                            </div>
                            <hr>

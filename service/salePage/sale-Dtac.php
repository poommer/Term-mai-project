...
<head>
    ...
    <title>เติมเงินมือถือ ค่ายDtac | trem-mai.com</title>
</head>
        ...
        <main>
            <div class="container">
                ...
                <div class="main-container">
                    <!-- main1 -->
                    <div class="pro-img">
                        <img src="../../img/game/3_Dtac.png" alt="">
                    </div>
                    <!-- end main1 -->
                    <!-- main2 -->
                    <div class="pro-inf">
                        <div class="pro-inf-name">
                            <h1>เติมเงินมือถือ ค่ายDtac</h1>
                        </div>
                        ...
                        <div class="pro-inf-details">
                            ...
                            <div class="sale-price">
                                <form action="">
                                    <input type="button" value="50 บาท" id="btn1" data-name="เติมเงินมือถือ ค่ายDtac 50 บาท" data-price="50.00" onclick="price(document.getElementById('btn1')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="100 บาท" id="btn2" data-name="เติมเงินมือถือ ค่ายDtac 100 บาท" data-price="100.00" onclick="price(document.getElementById('btn2')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="150 บาท" id="btn3" data-name="เติมเงินมือถือ ค่ายDtac 150 บาท" data-price="150.00" onclick="price(document.getElementById('btn3')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="300 บาท" id="btn4" data-name="เติมเงินมือถือ ค่ายDtac 300 บาท" data-price="300.00" onclick="price(document.getElementById('btn4')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="500 บาท" id="btn5" data-name="เติมเงินมือถือ ค่ายDtac 500 บาท" data-price="500.00" onclick="price(document.getElementById('btn5')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    <input type="button" value="1000 บาท" id="btn6" data-name="เติมเงินมือถือ ค่ายDtac 1000 บาท" data-price="1000.00" onclick="price(document.getElementById('btn6')); sumprice(); price_totail(); qty_totail(); " class="btn-price">
                                    </form>
                            </div>
                            <hr>
